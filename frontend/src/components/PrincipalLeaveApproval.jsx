        ...
        <div>
            ...
            <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                ...
                <p className="text-sm text-blue-600">
                    You can approve or reject leave requests from both staff and HODs.
                    ...
                    {leaves.map((leave) => (
                        <div key={leave.id} className="bg-white p-4 rounded-lg shadow-sm border">
                            <div className="flex justify-between items-start mb-3">
                                <div>
                                    <h4 className="font-semibold text-lg">{leave.staff_name}</h4>
                                    <p className="text-sm text-gray-600">
                                        {leave.staff_department} • {leave.staff_role}
                                    </p>
                                </div>
                            ...
                            {leave.user.role === 'STAFF' && (
                                <div className="mb-3 p-2 bg-green-50 rounded">
                                    <span className="text-sm font-medium text-green-800">HOD Approval:</span>
