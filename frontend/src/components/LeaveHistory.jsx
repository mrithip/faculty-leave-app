    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-4">
                ...
                <button onClick={onRefresh} className="bg-blue-500 text-white px-3 py-1 rounded text-sm">Refresh</button>
            </div>
            ...
            {leaves.length === 0 && <div className="text-center py-8 text-gray-500">No leave requests found.</div>}
        </div>
    );
}
